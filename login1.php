								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form class="form-horizontal" action="n1.php" method="post">
												<fieldset>
...
<noscript> JavaScript seems to be disabled in your browser! Please enable it! </noscript>
</html>
